...
export class SwitchButton extends LitElement {
	...
	static styles = css`
		:host {
			...
			background:
				linear-gradient(149deg, #fff 16.83%, #e4f0fa 83.63%) padding-box,
				linear-gradient(var(--border-gradient-angle), var(--border-gradient-first-color) var(--border-gradient-first-stop), var(--border-gradient-second-color) var(--border-gradient-second-stop)) border-box;
			box-shadow:
				0px 4px 9px 0px #c8d4e2,
				-5px -4px 5px 0px rgba(255, 255, 255, 0.75),
				0px 3px 7px 0px #c9d3e2;
