...
import "./components/switch-button.js";
import "./components/value-slider.js";
...
//     elements.compressorControls[num].value =
//       elements.compressorControls[id].value;
//     saveSettings();
//   };
...
// for (const presetButton of elements.presets.children) {
//   const preset = presets[presetButton.textContent];
...
//     } else {
//       elements.compressorControls[s].value = elements.compressorControls[
//         s + "Number"
//       ].value = settings[s];
//     }
//   }
...
// elements.currentSite.onchange = () => {
//   onCurrentSiteChange();
// };
// elements.removeSite.onclick = () => {
//   removeSite();
// };
...
//     .then(queryTabsCallback, console.error);
// }
...
//       elements.currentSite.options[elements.currentSite.options.length] =
//         option;
//     }
